...
{
  return (r1.campo() == r2.campo() and r1.dato() == r2.dato() and r1.igual() == r2.igual());
}

bool operator<(const Restriccion &r1, const Restriccion &r2)
{
  return (std::make_tuple(r1.campo(), r1.dato(), r1.igual()) < std::make_tuple(r2.campo(), r2.dato(), r2.igual()));
}
